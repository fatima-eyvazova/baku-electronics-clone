              ...
              <div className="product-options-child">
                <div className="product-options-block">
                  <div className="options-block">
                    <div onClick={() => toggleDropdown(0)} className="options-title">Ödəniş
                ...
                <div className="product-options-block">
                  <div className="options-block">
                    <div onClick={() => toggleDropdown(1)} className="options-title">Çatdırılma
                      <span className="down-icon">
                        <Image src={chevronDown}
                          width={18}
                          height={18}
                    ...
                    {showDropDown[1] && <div className={`option-lists`}>
                      <ul className="product-options-list">
                        <li className="product-options-item">Mağazadan götür</li>
                        <li className="product-options-item">Kuryerlə çatdırılma</li>
                        <li className="product-options-item">Sürətli çatdırılma</li>
                      </ul>
                ...
                <div className="product-options-block">
                  <div className="options-block">
                    <div onClick={() => toggleDropdown(2)} className="options-title">Zəmanət və servis
                      <span className="down-icon">
                        <Image src={chevronDown}
                          width={18}
                          height={18}
                    ...
                    {showDropDown[2] && <div className={`option-lists`}>
                      <ul className="product-options-list">
                        <li className="product-options-item">14 gün ərzində məhsulun <br />dəyişdirilməsi və ya qaytarılması.</li>
                      </ul>
            ...
            <div className="two-left">
              ...
              <div className="specs-table">
                <div className="specs-table-child">
                  <div onClick={() => toggleDropdown(3)} className="specs-table-title">Xüsusiyyətlər
                    <span className="down-icon">
                      <Image src={chevronDown}
                        width={18}
                        height={18}
